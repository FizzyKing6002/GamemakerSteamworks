...
for (var _player = 0; _player < array_length(playerList); _player++)
{
    ...
    var _ins = instance_create_layer(_pos.x, _pos.y, _playerLayer, obj_Player,
    {
    ...
    playerList[_player].character = _ins;
    playerList[_player].spawnPos = _pos;
    
    if playerList[_player].steamID == steamID then character = _ins
}
